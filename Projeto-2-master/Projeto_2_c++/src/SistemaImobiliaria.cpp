...
void SistemaImobiliaria::cadastrarCasa(){
    ...
    Imovel *casa = new Casa(numPavimentos, areaConstruida, numQuartos, areaTerreno);
...
void SistemaImobiliaria::cadastrarApartamento(){
    ...
    Imovel *apartamento = new Apartamento(numQuartos, area, vagasGaragem, valorCondominio, posicao);
    cadastrarImovel(casa);
